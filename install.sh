...
echo "    This copies the user default service to a modifiable version"
echo "    in .config/systemd/user and copies the user idle_detect.conf"
echo "    file to .config. Note that if the user install is not run"
echo "    the user default service version will be used, and the default"
echo "    user config will be copied on first run to the .config directory."
echo ""
